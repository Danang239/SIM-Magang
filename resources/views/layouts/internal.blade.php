            ...
            <div>
                ...
                <div class="px-6 py-5 border-b border-green-900 flex items-center space-x-3 bg-emerald-950">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-green-200 tracking-wider font-semibold uppercase leading-tight">Layanan PKL</p>
                    </div>
                </div>
                    ...
                    <div class="px-6 py-5 border-b border-green-900 flex items-center justify-between bg-emerald-950">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-[9px] text-green-200 tracking-wider font-semibold uppercase">Layanan PKL</p>
                            </div>
                        </div>
