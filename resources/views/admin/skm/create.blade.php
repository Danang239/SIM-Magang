<x-layouts.internal>
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 font-sans mt-3">Tambah Pertanyaan SKM</h2>
        <p class="text-xs text-gray-400 mt-1">Buat indikator kepuasan pelayanan baru yang akan dinilai oleh peserta magang yang telah selesai.</p>
    </div>
    ...
    <div class="max-w-2xl bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.skm-pertanyaan.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea id="teks_pertanyaan" name="teks_pertanyaan" rows="4"
                    ...
                    placeholder="Contoh: Sarana prasaran praktikum di Balai dinilai sangat menunjang kompetensi saya."
            ...
            <div>
                ...
                <x-text-input id="urutan" name="urutan" type="number" class="mt-1 block w-full text-xs rounded-xl border-gray-200 focus:ring-biogen-medium focus:border-biogen-medium" :value="old('urutan', $nextUrutan)" min="1" required />
