        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6" x-data="{ showPass: false }">
                ...
                <div class="relative mt-1 w-3/4">
                    <input id="password" name="password" :type="showPass ? 'text' : 'password'" class="w-full pl-4 pr-10 py-2.5 rounded-xl border border-gray-300 focus:ring-red-500 focus:border-red-500 text-sm" placeholder="{{ __('Password') }}" />
