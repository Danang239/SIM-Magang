    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div x-data="{ showCurrent: false }">
            ...
            <div class="relative mt-1">
                <input id="update_password_current_password" name="current_password" :type="showCurrent ? 'text' : 'password'" class="w-full pl-4 pr-10 py-2 rounded-xl border border-gray-300 focus:ring-biogen-medium focus:border-biogen-medium text-sm" autocomplete="current-password" />
        ...
        <div x-data="{ showNew: false }">
            ...
            <div class="relative mt-1">
                <input id="update_password_password" name="password" :type="showNew ? 'text' : 'password'" class="w-full pl-4 pr-10 py-2 rounded-xl border border-gray-300 focus:ring-biogen-medium focus:border-biogen-medium text-sm" autocomplete="new-password" />
        ...
        <div x-data="{ showConfirm: false }">
            ...
            <div class="relative mt-1">
                <input id="update_password_password_confirmation" name="password_confirmation" :type="showConfirm ? 'text' : 'password'" class="w-full pl-4 pr-10 py-2 rounded-xl border border-gray-300 focus:ring-biogen-medium focus:border-biogen-medium text-sm" autocomplete="new-password" />
